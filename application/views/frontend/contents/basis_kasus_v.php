    ...
    <div class="col-md-12">
         <div class="box-body">
            <div class="form-group">
                <button type="button" onClick="add_kasus();" class="btn btn-primary" id="add-kasus" >Tambah</button><br/><br/> 
...
<script type="text/javascript">
    var baseUrl = base_url() + 'basis_kasus/';
    ...
    function add_kasus()
    {
        ...
        $('.modal-title').text('Tambah kasus'); // Set Title to Bootstrap modal title
    }

    function update_kasus(kode_kasus)
    {
         $.ajax({
            url: baseUrl + "update_kasus/",
        ...
        $('#modal-form').modal('show'); // show bootstrap modal
        $('.modal-title').text('Update kasus'); // Set Title to Bootstrap modal title
    }
