...
class Ion_auth_model extends CI_Model
{
	...
	public function register($identity, $password, $email, $additional_data = array(), $groups = array())
	{
		...
		$data = array(
		    ...
		    'created_on' => unix_to_human(time())
		);

		$data['active'] =  isset($additional_data['active']) ? $additional_data['active'] : ($manual_activation === false ? 1 : 0);
	...
	**/
	...
	public function update_last_login($id)
	{
		...
		$this->db->update($this->tables['users'], array('last_login' => unix_to_human(time())), array('id' => $id));
