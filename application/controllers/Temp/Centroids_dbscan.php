...
class Centroids_dbscan extends CI_Controller
{

    protected $page_header = 'Cluster Centroid For DBSCAN';
    protected $module      = '';
    protected $url         = array();
    ...
    public function __construct()
    {
        ...
        $this->load->model('centroids_dbscan_model', 'centroids');
    }
